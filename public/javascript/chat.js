...
function send_message(sender, receiver, text_data) {
   // console.log(text_data);
    save_data_and_return_component(sender, receiver, text_data, function(result) {
        console.log(result);
        if(result) {
...
function save_data_and_return_component(sender, receiver, message, handle_data) {
    /*

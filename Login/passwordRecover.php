<?php
    ...
    if(isset($_POST["send"])) {
        if(Token::check(Common::getInput($_POST, "token_conf_send"), "reset-password")) {
            ...
            if($validate->passed()) {
                ...
                if($exists) {
                    ...
                    $mg = new Mailgun("0f35fde9cb94dad3e5a41f9c1cb92b2a-b2f5ed24-f4e2f139");
                    $domain = "pubkey-8c4c1006aea23c6f7e9f0d4b8e915408";
